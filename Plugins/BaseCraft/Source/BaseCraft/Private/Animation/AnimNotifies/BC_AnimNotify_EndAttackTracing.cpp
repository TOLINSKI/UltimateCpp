...
#include "Animation/AnimNotifies/BC_AnimNotify_EndAttackTracing.h"
#include "Interfaces/BC_AttackerInterface.h"
#include "Interfaces/BC_WeaponInterface.h"

void UBC_AnimNotify_EndAttackTracing::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation,
...
FString UBC_AnimNotify_EndAttackTracing::GetNotifyName_Implementation() const
{
	return FString("End Attack Tracing");
}
